//Sidhardh Burre, ssb3vk@virginia.edu, 3/19/2021, BinarySearchTree.h
...
private:
	...
	// Sid: a private helper for insert to allow for recursion. returns
	// a BinaryNode to recurse over
    ...
    //Sid: a private helper for pathTo.
    string pathTo(BinaryNode* n, const string& x) const; 
    
    //Sid: a private helper for find. 
    bool find(BinaryNode* n, const string& x) const;
    
    //Sid: a privat helper for numNodes. 
